...
归档详情页可以随时填写或修改 1–10 分评分、一句话短评、标签和观后感，归档列表会显示评分与约合时长。升级前已经归档的收藏，其逐集数据无法恢复，因此首次确认时间会标为“旧归档未保留”；总集数、约合时长、追踪跨度和归档日期仍会自动补齐。归档收藏在“追番 → 归档收藏”中查看；永久删除收藏仍需标题确认。升级数据库不会自动归档任何现有条目，只有明确点击“已观看”或手工确认归档才会触发。
